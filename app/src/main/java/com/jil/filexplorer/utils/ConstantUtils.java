...
public class ConstantUtils {
    ...
    public final static int SELECTED_COLOR =Color.argb(70,21,143,197);//item被选中时的颜色
    ...
    public final static String PROGRESS_ID = "com.jil.filexplorer.copy_action";
    ...
    //   %s字符串       %i+ 数字上升       %i- 数字下降    %e+ 字母上升   %e-字母下降
    public final static String EXPLAME = "%s=jil" + "%i+=5"+"%e+=a";
